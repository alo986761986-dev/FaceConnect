  ...
  return (
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent 
          align="end" 
          className="w-72 bg-[#1A1A1A] border-white/10 text-white p-2"
        >
          {/* End-to-End Encryption Badge */}
          <div className="px-3 py-2 mb-2 bg-green-500/10 rounded-lg border border-green-500/20">
          ...
          <DropdownMenuItem 
            ...
            className="flex items-center gap-3 py-2.5 px-3 cursor-pointer hover:bg-white/10 rounded-lg"
          >
          ...
          {/* Change Theme */}
          <DropdownMenuSub>
            <DropdownMenuSubTrigger className="flex items-center gap-3 py-2.5 px-3 cursor-pointer hover:bg-white/10 rounded-lg">
              <Palette className="w-4 h-4 text-gray-400" />
              <span>Change theme</span>
            </DropdownMenuSubTrigger>
            <DropdownMenuSubContent className="bg-[#1A1A1A] border-white/10 text-white p-2 w-56">
          ...
          >
            ...
            <span>Create group with {otherParticipant?.username}</span>
          </DropdownMenuItem>
          ...
          <DropdownMenuItem 
            ...
            className="flex items-center justify-between py-2.5 px-3 cursor-pointer hover:bg-white/10 rounded-lg"
          >
            <div className="flex items-center gap-3">
              <BellOff className="w-4 h-4 text-gray-400" />
              <span>Turn off notifications</span>
            </div>
            <Switch checked={isMuted} onCheckedChange={handleToggleNotifications} />
          </DropdownMenuItem>
          ...
          <DropdownMenuItem 
            ...
            className="flex items-center gap-3 py-2.5 px-3 cursor-pointer hover:bg-red-500/10 rounded-lg text-red-400"
          >
